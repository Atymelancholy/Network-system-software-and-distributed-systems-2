...
public final class Lab7App {
    static final int DEFAULT_N = 3072;
    static final int DEFAULT_STRIPS = 8;
    ...
    static void prepareRootMatrices(double[] a, double[] b, double[] c, int rank) {
        if (rank != 0) {
            return;
        }
    ...
    static void multiply(LabSettings settings, double[] a, double[] b, double[] c) throws MPIException {
